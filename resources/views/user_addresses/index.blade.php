                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($addresses as $address)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ route('user_addresses.edit',['address'=>$address->id]) }}">修改</a>
                                    {{--<form action="{{ route('user_addresses.destroy',['address'=>$address->id]) }}" method="post" style="display: inline;">--}}
                                        {{--{!! csrf_field() !!}--}}
                                        {{--{!! method_field('delete') !!}--}}
